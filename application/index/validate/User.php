...
class User extends BasicValidate {
    ...
    protected $scene = [
        ...
        'save'   => ['id' => 'number', 'company' => 'require|max:255', 'stage' => 'require|max:255', 'website' => 'url', 'industry' => 'max:255', 'legal_person' => 'require|max:255', 'duty' => 'max:255', 'mobile' => 'require|length:11|regex:mobile', 'phone' => 'max:255', 'email' => 'require|email', 'register_address' => 'require|max:255', 'business_license' => 'max:255', 'register_capital' => 'require|number', 'license_scan' => 'require', 'mailing_address' => 'max:255', 'sales_volume' => 'max:255', 'total_people' => 'require|number', 'developer_people' => 'require|number', 'patent' => 'max:255', 'high_technology' => 'require|number|in,0,1', 'service_direction'=> 'max:255', 'products_introduce' => 'require|min:300', 'business_introduce' => 'require|min:300', 'logo' => 'require'],
    ];
}